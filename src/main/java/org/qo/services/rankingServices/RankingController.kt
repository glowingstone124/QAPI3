...
class RankingController(
	...
	suspend fun downloadPlace(): ResponseEntity<String> {
		return ri.GeneralHttpHeader(service.download(RankingKind.PLACE))
	}

	@PostMapping("/qo/place/upload", "/qo/place/upload/")
	suspend fun uploadPlace(@RequestBody body: String, @RequestHeader("Token") token: String): ResponseEntity<String> {
